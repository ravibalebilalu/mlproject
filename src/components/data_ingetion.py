...
class DataIngetion:
    ...
    def initialise_data_ingetion(self):
        logging.info("Entered the data ingetion method or component")
        try:
            df = pd.read_csv("/config/workspace/mlproject/notebook/data/StudentsPerformance.csv")
            ...
            logging.info("ingetion of data is compleated")
...
if __name__ == "__main__":
    ...
    obj = DataIngetion()
    train_data,test_data= obj.initialise_data_ingetion()
