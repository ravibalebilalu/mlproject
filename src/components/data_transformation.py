...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logging.info("Numerical  columns standard scaling compleated")                               
            logging.info("Categorical columns encoding compleated")                               

            preprocessor = ColumnTransformer(
                [
                    ("num_pipeline",num_pipeline,numerical_columns),
                    ("cat_pipeline",catagorical_pipeline,categorical_columns)
                ]
            )
            return preprocessor
